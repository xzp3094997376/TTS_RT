...
namespace Crosstales.RTVoice.Provider
{
    ...
    public abstract class BaseVoiceProvider : IVoiceProvider
    {
        ...
        //protected System.Collections.Generic.Dictionary<string, System.Threading.Thread> workers = new System.Collections.Generic.Dictionary<string, System.Threading.Thread>();
#endif
        ...
        public virtual void Silence()
        {
            ...
            /*
            foreach (System.Collections.Generic.KeyValuePair<string, System.Threading.Thread> kvp in workers)
            {
                Debug.Log("workers-kvp: " + kvp);
        ...
        public virtual void Silence(string uid)
        {
            ...
            if (!string.IsNullOrEmpty(uid))
            {
                ...
                /*
                if (workers.ContainsKey(uid) && workers[uid].IsAlive)
                {
                    workers[uid].Abort();
                }
                workers.Remove(uid);
...
#if UNITY_STANDALONE || UNITY_EDITOR
        protected void startProcess(ref System.Diagnostics.Process process, int timeout = 0)
        {
            try
            {
        ...
        {
            //Debug.Log("Output file: " + outputFile);
