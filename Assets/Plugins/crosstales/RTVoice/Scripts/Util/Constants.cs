...
namespace Crosstales.RTVoice.Util
{
    ...
    public abstract class Constants : Common.Util.BaseConstants
    {
        ...
        public const string ASSET_VERSION = "2019.1.3";

        /// <summary>Build number of the asset.</summary>
        public const int ASSET_BUILD = 20190211;
        ...
        public static readonly System.DateTime ASSET_CHANGED = new System.DateTime(2019, 2, 11);
        ...
        public const string ASSET_API_URL = "http://goo.gl/6w4Fy0"; // checked: 02.07.2018
        //public const string ASSET_API_URL = "http://www.crosstales.com/en/assets/rtvoice/api/";

        /// <summary>URL of the asset forum.</summary>
        public const string ASSET_FORUM_URL = "http://goo.gl/Z6MZMl"; // checked: 02.07.2018
        ...
        public const string DEFAULT_TTS_LINUX = "espeak"; //@"C:\Users\Stefan\Desktop\eSpeak\espeak.exe";
        //public const string DEFAULT_TTS_LINUX = "espeak-ng";
        public const string DEFAULT_TTS_LINUX_DATA = ""; //@"C:\Users\Stefan\Desktop\eSpeak\espeak-data";
		...
		/*
        /// <summary>Defines the speed of 'Speak'-calls in ticks (10'000'000 = 1 second).</summary>
        public static long SPEAK_CALL_SPEED = 5000000; //0.5 seconds
		*/
