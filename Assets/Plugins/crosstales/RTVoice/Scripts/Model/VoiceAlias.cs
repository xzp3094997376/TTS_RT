...
namespace Crosstales.RTVoice.Model
{
    ...
    public class VoiceAlias
    {
        ...
        public Enum.Gender Gender = Enum.Gender.UNKNOWN;
        ...
        public Voice Voice
        {
            get
            {
                Model.Voice result = Speaker.VoiceForName(VoiceName);

                if (result == null)
                {
                    result = Speaker.VoiceForGender(Gender, Culture);
                }
